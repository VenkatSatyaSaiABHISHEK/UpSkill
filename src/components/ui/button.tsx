...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-md hover:bg-primary/95 shadow-black/5 dark:shadow-white/5",
        destructive:
        ...
        glass: "bg-background/10 dark:bg-background/20 backdrop-blur-md border border-border/40 hover:bg-background/20 dark:hover:bg-background/30 text-foreground shadow-sm",
      },
      size: {
